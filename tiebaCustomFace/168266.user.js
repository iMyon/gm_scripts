...
// @updateURL      https://gist.github.com/iMyon/a8bab76ba950f571e96a
// @downloadURL    https://gist.github.com/iMyon/a8bab76ba950f571e96a/raw/168266.user.js
// @description    贴吧自定义表情
...
//表情滚动条默认滚到顶部
var faceScrollTop = function(){
  var scrollStyle = $('.tbui_scroll_button').attr('style');
  //内容滚动到顶部
  $('.tbui_panel_content').scrollTop(0);
  //滚动条滚到头部
  $('.tbui_scroll_button').attr('style',scrollStyle.replace(/top\s*:\s*(\d|\.)*px/,"top:0px"));
}
