...
// @downloadURL https://github.com/iMyon/gm_scripts/raw/master/%E8%B4%B4%E5%90%A7%E6%B6%88%E6%81%AF%E6%8F%90%E9%86%92/151214.user.js
// @updateURL   https://github.com/iMyon/gm_scripts/raw/master/%E8%B4%B4%E5%90%A7%E6%B6%88%E6%81%AF%E6%8F%90%E9%86%92/151214.meta.js
    ...
    window.checkNow = function() {
        ...
        GM_xmlhttpRequest({
            ...
            onload: function(response) {
                ...
                note = '<div id="note">';
                if (fans != 0) {
                    note += '<div>' + n[0] + '个' + '<a>新粉丝</a></div>';
                    tltle += n[0] + '粉丝  ';
                }
                if (reply != 0) {
                    note += '<div>' + n[3] + '个' + '<a id="reply" target="_blank" href="http://tieba.baidu.com/i/sys/jump?u=&type=replyme">新回复</a></div>';
                    title += n[3] + '回复  ';
                }
                if (AtMe != 0) {
                    note += '<div>' + n[8] + '个' + '<a id="atme" target="_blank" href="http://tieba.baidu.com/i/sys/jump?u=&type=atme">@提到我</a></div>';
                    title += n[8] + '个@提到我';
                }
                if (trash != 0) {
                    note += '<div>' + n[9] + '个' + '<a id="trash" target="_blank" href="http://tieba.baidu.com/pmc/recycle">回收站提醒</a></div>';
                    title += n[9] + '回收站';
                }
