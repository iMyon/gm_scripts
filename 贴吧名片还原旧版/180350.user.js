...
var un = '',
    ...
    offsetTop = '',
    offsetLeft = '';
$('.j_user_card,.p_author_face ').hover(function() {
    userHover(this);
});
...
var observeNewUserDom = function(records) {
    records.forEach(function(record) {
        Array.prototype.forEach.call(record.addedNodes, function(element) {
            if (element.getAttribute('class')&&element.getAttribute('class').indexOf("core_reply_content")) {
                $(element).find('.j_user_card').hover(function() {
                    userHover(this);
                });
            }
        });
